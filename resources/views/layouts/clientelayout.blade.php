        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <a href="conocenos" class="nav-item nav-link">Conocenos</a>
                    <a href="servicios" class="nav-item nav-link">Servicios</a>
                    <a href="clientemenu" class="nav-item nav-link">Menu</a>
                    <a href="misreservaciones" class="nav-item nav-link">Reservaciones</a>
                    <a href="contactanos" class="nav-item nav-link">Contactanos</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">{{ auth()->user()->name }} </a>
                        <div class="dropdown-menu text-capitalize">
                            <a href="{{route('login.destroy')}}" class="dropdown-item">Cerrar Sesion</a>
                        </div>
                    </div>
                </div>
            </div>
